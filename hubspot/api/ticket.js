...
async function getTickets(accessToken, options = {}) {
...
async function createTicket(accessToken, data) {
  return await request.post('https://api.hubapi.com/crm/v3/objects/tickets', {
    headers: {
