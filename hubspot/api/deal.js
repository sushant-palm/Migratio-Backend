...
async function getDeals(accessToken, options = {}) {
...
async function createDeal(accessToken, data) {
  return await request.post('https://api.hubapi.com/crm/v3/objects/deals', {
    headers: {
